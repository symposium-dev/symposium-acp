...
pub mod custom_message_handlers {
    ...
    //!
    //! For reusable message handling logic, implement [`JsonRpcMessageHandler`] and use
    ...
    //!
    //! ```
    //! use sacp::{JsonRpcMessageHandler, MessageCx, Handled, JrConnectionCx};
    ...
    //!
    //! [`JsonRpcMessageHandler`]: sacp::JsonRpcMessageHandler
